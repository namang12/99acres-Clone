...
const LoginForm = ({ closeModal, switchToSignUp }) => {
  ...
  return (
    <div>
        ...
        <div class="card">
          <div class="row">
            <div class="col custom-widthh" style={{width:"249px"}}> {/* Updated col-md-4 to col-md-6 */}
              <div class="h-100 d-flex justify-content-center align-items-center">
                <div class="py-4 px-3">
                  ...
                  <div class="row mt-2 mb-2">
                    <div class="col-md-12">
                      <div class="input-field">
                        <input class="form-control" id="input4" value={password} onChange={(e) => setPassword(e.target.value)} required />
                  ...
                  <div class="member mt-1">
                    ...
                    <span className="switch-link" onClick={switchToSignUp} style={{color: "blue"}}><u>Sign Up!</u>
