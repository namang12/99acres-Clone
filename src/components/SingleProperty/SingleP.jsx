                ...
                <div className="overlap">
                  <div className="div-component-2">
                    <div className="overlap-group">
                      ...
                      <div className="text-wrapper-9">{price / 1000}.0K</div>
                    </div>
            ...
            <div className="div-4">
              <div className="div-component-5">
                <div className="div-overviewcarousel">
                  <img className="propimg" alt="propimg" src={imageProperty} />
                </div>
              </div>
                ...
                <div className="row">
                  <div className="data">
                    ...
                    <div className="div-factarea">
                      ...
                      <div className="text-wrapper-30">{propertyArea}.0</div>
                  ...
                  <div className="data">
                    ...
                    <div className="div-component-8">
                      ...
                      <div className="text-wrapper-37">
                        {bhk > 3 ? (bhk > 5 ? bhk - 2 : bhk - 1) : bhk} Balcony
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="div-18">
                <div className="list-2">
                  ...
                  <div className="item-4">
                    <div className="text-wrapper-46">Property Ownership</div>
