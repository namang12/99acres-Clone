...
const Faq = () => {
  return (
    <div className="faq-post">
        <p className="text-wrapper-29">KNOW MORE ABOUT POSTING ON 99acres</p>
        ...
        <div className="all-accordion">
            ...
            <AccordionDetails>
              <Typography>
                <p className="div-9">
                  ...
                  99acres.com is the best property portal to sell or rent out
                  your property fast!
                </p>
              </Typography>
            </AccordionDetails>
            ...
            <AccordionDetails>
              <Typography>
                <p className="div-9">
                  ...
                  selling/renting on 99acres.com for FREE. There are no charges
                  involved. All buyer/tenant enquiries will be shared with you
                  completely free of cost.
                  <br />
                  <br />
                  You can drop a ‘Hi’ on WhatsApp at 882 682 1122 to post easily
                  for FREE
                  <br />
                  <br />
                  You can also explore our additional services to attract even
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                <p className="div-9">
                  Yes, you can easily rent out or sell your property as an owner
                  on 99acres.com by posting your property ad for free. Your
                  property will be visible to thousands of buyers and tenants
                  visiting us daily, without involving any real estate agents.
                </p>
              </Typography>
            </AccordionDetails>
          </Accordion>
            ...
            <AccordionDetails>
              <Typography>
                <p className="div-9">
                  ...
                  property listings. 99acres.com is the only platform where you
                  get unlimited enquiries (with no cap) even on a free property
                  ad. You should add detailed information and appealing photos
                  receive maximum enquires from prospective buyers or tenants.
                </p>
              </Typography>
            </AccordionDetails>
          </Accordion>
